...
<form style="width: 500px; height: 600px" class="border border-danger border-5 rounded-5 m-auto p-5" method="post">
<center><i>Verification...</i></center>
  ...
  <div class="form-floating mb-3">
    <input value="<?php if(isset($newPassword) == true) echo $newPassword; ?>" type="password" class="form-control" id="newPassword" name ="newPassword" placeholder="newPassword", autocomplete="new-Password">
