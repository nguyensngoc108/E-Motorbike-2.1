<?php
  ...
  if(isset($_POST['btnsignin']) == true) {
    ...
    if($st->rowCount() == 1) {
      $user = $st->fetch();
      $_SESSION['login_Account']   = $user['Account'];
      ...
      header('Location: http://localhost:3000/frontend/php/index-signinalready.php');
      exit();
    }
    else { ?>
      <i><center>Your account or password does not exist</center></i>
      <?php
        header('Location: http://localhost:3000/final/iug-signin-ag.php');
        exit();
      }
...
<center><i>Welcome...</i></center>
  ...
  <i><center><a href="http://localhost:3000/final/iug-forgotpass.php">Forgotten password?</a></center></i>
...
<center><p>_____________________________________________</p></center>
  ...
  <a font-size:medium; style="font-family:'Raleway SemiBold', Raleway, Serif; height:40px; width:150px" class="btn btn-success" href="http://localhost:3000/final/iug-signup.php" role="button">Sign up</a>

  <i><center><a href="/final/index.php">Back to Menu</a></center></i>
