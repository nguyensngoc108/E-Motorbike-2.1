...
<header>
    ...
    <div class="others">
        ...
        <li> <a class="fa fa-user" href="/backend/signup-signin/iug-signup.php" ></a></li>
        <span><?php 
        echo "Chao ban!"?></span>
...
<section id="Slider">
            <div class="aspect-ratio-169">
                <img src="/frontend/images/Bg.jpeg" width="100%" height="100%">
                <img src="/frontend/images/Repair.jpg" width="100%" height="100%">
                <img src="/frontend/images/About.jpg" width="100%" height="100%">
                <img src="/frontend/images/Painting.jpg" width="100%" height="100%">
            </div>
