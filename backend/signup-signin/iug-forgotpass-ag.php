...
<h4><span style ="font-family:'Raleway Bold', Raleway, Serif">DETERMINE YOUR IDENTITY</span></h4>
  ...
  <div class="form-floating mb-3">
    <input value="<?php if(isset($Email) == true) echo $Email?>" type="email" class="form-control is-invalid" id="Email" name="Email" aria-describedby="EmailRemind", placeholder ="Email">
    <label for="Email">Email</label>
    <em class="invalid-feedback">Oops, we can't find your account.</em>
  </div>
...
<head>
    ...
    <title>IUG - Change Your Password</title>
</head>
<body>
