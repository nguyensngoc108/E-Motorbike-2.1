...
<header>
    ...
    <div class="menu">
        ...
        <li><a href="">ACCESSORIES</a>
            <ul class="sub-menu">
                ...
                <li><a herf="service2.html">Sửa chữa</a></li>
                    <ul>
                ...
                <li><a herf="service3.html">Nâng cấp</a></li>
                    <ul>
                ...
                <li><a herf="service4.html">Thay đổi kết cấu</a></li>
                    <ul>
                ...
                <li><a herf="service5.html">Lên đời</a></li>
                    <ul>
    ...
    <div class="others">    
        ...
        <li><a class="fa fa-sign-out" href="http://localhost:3000/final/index.php" 
        <?php unset($_SESSION['login_Account']); unset($_SESSION['login_Password']); session_destroy();?>></a></li>
        
        <span><?php
        echo "Chao " .$_SESSION['login_Fullname'] . "!"?></span>
