  ...
  if(isset($_POST['btnsignin']) == true) {
    ...
    $Password = $_POST['Password'];
        ...
        if($st->rowCount() == 1) {
            ...
            header('Location: http://localhost:3000/final/index-signinalready.php');
            exit();
        }
        else {
...
<center><i>Whoops, looks like something went wrong...</i></center>
</br>
<!-- <div class="form-floating">
  <input type="email" class="form-control is-invalid" id="Account1" placeholder="Account1" value="">
  <label font-size: medium; for="Account1"></label>
</div> -->

<div class="form-floating mb-3">
  <input <?php if(isset($Account) == true) echo $Account; ?> type="text" class="form-control is-invalid" id="Account" name="Account" placeholder="Account", autocomplete="new-Account">
  <label for="Account">Account</label>
  <em class="invalid-feedback">Please enter your "account" EXACTLY.</em>
</div>
...
<div class="form-floating mb-3">
  ...
  <em class="invalid-feedback">Please enter your "password" EXACTLY.</em>
</div>
  <i><center><a href="http://localhost:3000/iug-forgotpass.php">Forgotten password?</a></center></i>

  <!-- <div class="mb-3">
    <label for="Account" class="form-label"></label>
    <input value="<?php if(isset($Account) == true) echo $Account; ?>" type="text" class="form-control" id="Account" name="Account" placeholder="Account">
  </div>

  <div class="mb-3">
    <label for="Password" class="form-label"></label>
    <input value="<?php if(isset($Password) == true) echo $Password; ?>" type="password" class="form-control" id="Password" name ="Password" placeholder="Password">
  </div> -->
...
<!-- <i><font color ="red">Your Account or Password does not exist!!</font></i> -->
